...
export function readSafetyAcceptance(): SafetyAcceptance | null {
  try {
...
export function writeSafetyAcceptance(): SafetyAcceptance {
...
export function clearSafetyAcceptance(): void {
